        ...
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
            ...
            <div>
                ...
                <div>
                    ...
                    <label htmlFor='upload1' className='inline-flex gap-3 px-8 py-3.5 rounded-full  cursor-pointer bg-gradient-to-r from-blue-700 to-blue-400  m-auto hover:scale-105 transition-all duration-700'>
            ...
            <div className='w-full max-w-md '>
                <img className='w-[90%] ml-10'src={heroBG} alt="" />
            </div>
        </div>
    )
}
